...
import { User, Mail, Phone, Shield, Edit, Save, X, Camera, AlertCircle } from 'lucide-react';
        ...
        <div className="px-6 sm:px-8 py-8 sm:py-12">
          <div className="flex flex-col sm:flex-row items-center space-y-6 sm:space-y-0 sm:space-x-8">
            ...
            <div className="relative group">
              ...
              <button className="absolute bottom-0 right-0 w-8 h-8 sm:w-10 sm:h-10 bg-blue-500 hover:bg-blue-600 rounded-full flex items-center justify-center shadow-lg transition-colors duration-200 border-2 border-white">
