        ...
        {notesLoading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[1020px] border-collapse">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="px-4 py-2.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider bg-gray-50">Départ</th>
                  ...
                  <th className="px-4 py-2.5 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider bg-gray-50">Poids théorique</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {notes.map(n => {
                  ...
                  const poidsTheorique = n.poids_theorique_total ?? 0;
                  ...
                  return (
                    <tr key={n.id} className={`transition-colors hover:bg-blue-50/50 ${isApure ? 'bg-slate-50/60' : ''}`}>
                      <td
                        className="px-4 py-2.5 text-sm font-medium text-gray-800 whitespace-nowrap cursor-help"
                        title={n.depart_id ? `BL: ${n.depart_num_bl || '—'}\nTC: ${n.depart_num_tc || '—'}\nArrivée Tana: ${formatDate(n.depart_date_arrivee_tana)}` : undefined}
                      >
                        {n.depart_id ? `#${n.depart_id}` : '—'}
                      </td>
                      ...
                      <td className="px-4 py-2.5 text-right text-sm text-gray-600 whitespace-nowrap">{poidsTheorique.toFixed(2)} kg</td>
