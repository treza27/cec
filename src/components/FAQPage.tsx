...
export default function FAQPage() {
  ...
  return (
    <>
      <SEO
        title="FAQ — Questions fréquentes sur le transport maritime Chine-Madagascar"
        description="Trouvez les réponses à vos questions sur le transport maritime entre la Chine et Madagascar : délais, tarifs, suivi colis, dédouanement, groupage LCL et FCL."
        canonical="/faq"
        schema={faqSchema}
      />
