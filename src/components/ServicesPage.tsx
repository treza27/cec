...
import { Ship, Container, Briefcase, Shield, Clock, DollarSign, Globe, Anchor, ArrowRight } from 'lucide-react';
import SEO from './SEO';
...
export default function ServicesPage({ onNavigate }: ServicesPageProps) {
  ...
  const servicesSchema = [
    {
      ...
      '@type': 'Service',
      name: 'Transport maritime LCL – Groupage de fret',
      description: 'Service de groupage maritime LCL entre la Chine et Madagascar. Entrepôts à Guangzhou et Yiwu. Solution flexible et économique pour tous les volumes.',
      provider: {
        '@type': 'Organization',
      ...
      serviceType: 'Fret maritime groupage LCL',
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Service',
      name: 'Transport maritime FCL – Conteneur complet',
      description: 'Service de conteneur complet FCL entre la Chine et Madagascar. Solution idéale pour les grands volumes avec sécurité maximale.',
      provider: {
        '@type': 'Organization',
        name: 'Continental Express Cargo',
        url: 'https://continentalexpresscargo.com',
      ...
      areaServed: 'Madagascar',
      serviceType: 'Fret maritime conteneur complet FCL',
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Service',
      name: 'Conseil et accompagnement import',
      description: 'Service de conseil et accompagnement pour l\'importation de marchandises de Chine à Madagascar : sourcing fournisseurs, négociation, dédouanement.',
      provider: {
        '@type': 'Organization',
        name: 'Continental Express Cargo',
        url: 'https://continentalexpresscargo.com',
      ...
      areaServed: 'Madagascar',
      serviceType: 'Conseil import Chine Madagascar',
    },
  ];
  ...
  return (
    <>
      <SEO
        title="Nos Services de Transport Maritime Chine-Madagascar"
        description="Découvrez nos services de fret maritime LCL (groupage), FCL (conteneur complet) et conseil import entre la Chine et Madagascar. Solutions flexibles et économiques pour vos importations."
        canonical="/services"
            ...
            return (
              ...
              >
                ...
                <div className={`mt-6 pt-6 border-t ${colors.border}`}>
                  <p className={`text-sm font-semibold ${colors.text} flex items-start mb-4`}>
                    <span className="mr-2">→</span>
                    <span>{service.highlight}</span>
                  </p>
                  <button
                    onClick={() => onNavigate?.(service.page)}
                    className={`inline-flex items-center space-x-2 text-sm font-semibold ${colors.text} hover:opacity-70 transition-opacity duration-200 group`}
                  >
